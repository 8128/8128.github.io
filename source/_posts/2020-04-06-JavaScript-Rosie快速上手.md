...
katex: false
hide: false
date: 2020-04-06 15:54:39
tags: 
	- javascript
	- code
	- tutorial
categories: javascript
description: 快速入门工厂方法插件
cover: https://raw.githubusercontent.com/8128/PicGo/master/20200406155734.png
top_img:
keywords:
---

传送门：[Github](https://github.com/rosiejs/rosie),只是给readme稍微加了点注释

# Rosie

是个工厂工具，用来生产js对象，对于生产test数据最好用

Rosie is a factory for building JavaScript objects, mostly useful for setting up test data. 
...
定义工厂：使用define方法先定义好工厂的各个properties等内容。sequence表示递增数
...
假如你想要override其中的一些attribute，你可以自己传入值强制覆盖
...
- **instance.after(`callback`)** - register a `callback` function that will be called at the end of the object build process. The `callback` is invoked with two params: (`build_object`, `object_options`). See the [Post Build Callback](https://github.com/rosiejs/rosie#post-build-callback) section for examples.
