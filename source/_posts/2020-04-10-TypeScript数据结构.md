...
来源：[深入理解typescript](https://jkchao.github.io/typescript-book-chinese/typings/overview.html)
...
当稍后在 [环境声明](https://jkchao.github.io/typescript-book-chinese/typings/ambient.html) 章节中提及 `lib.d.ts` 时，我们会讨论更多关于 `Array` 的信息。
